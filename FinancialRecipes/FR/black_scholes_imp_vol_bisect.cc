...
/* I've basically copied the above code and am calling option_price_put_black_scholes() instead
   to implement the put version. Hope this works!  -- B.Muth */

double option_price_implied_volatility_put_black_scholes_bisections (const double& S,
	const double& K,
	const double& r,
	const double& time,
	const double& option_price)
